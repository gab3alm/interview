<scene1-content>
  <!-- HTML -->
  <div class="sc1-content-container animated fadeIn">
    ...
    <div class="sc1-outer-information-container"><!-- absolute container -->
      <div class="sc1-inner-information-container"><!-- relative container -->
        ...
        <div class="sc1-btn-container">
          <a href="#steps/starting-job-search" class="sc-btn sc1-btn button button-3d button-action button-pill">learn more</a>
        </div>
